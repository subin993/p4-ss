...
control IngressP(
    ...
    Register<bit<16>, bit<32>>(32w65536) hot_flow_counter0;
    RegisterAction<bit<16>, bit<32>, bit<16>>(hot_flow_counter0) hot_flow_counter0_read = {
    ...
    Register<bit<16>, bit<32>>(32w65536) hot_flow_counter1;
    RegisterAction<bit<16>, bit<32>, bit<16>>(hot_flow_counter1) hot_flow_counter1_read = {
        void apply(inout bit<16> value, out bit<16> read_value) {
            read_value = value;
            value = value + 1;
        }
    ...
    Register<bit<16>, bit<32>>(32w65536) hot_flow_counter2;
    RegisterAction<bit<16>, bit<32>, bit<16>>(hot_flow_counter2) hot_flow_counter2_read = {
        void apply(inout bit<16> value, out bit<16> read_value) {
            read_value = value;
            value = value + 1;
        }
